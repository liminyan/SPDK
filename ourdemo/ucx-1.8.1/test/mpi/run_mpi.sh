...
{
	export MPIRUN=
	export LIBUCS=/global/home/users/liyiyuan/exe3/ucx-1.8.1/src/ucs/.libs/libucs.so
	export LIBUCT=/global/home/users/liyiyuan/exe3/ucx-1.8.1/src/uct/.libs/libuct.so
	export LIBUCP=/global/home/users/liyiyuan/exe3/ucx-1.8.1/src/ucp/.libs/libucp.so
	export VERBOSE=0
	export EXE=""
	export EXE_ARGS=""
...
run_open_mpi()
{
	...
	then
		...
		EXE="valgrind \
			...
			--suppressions=/global/home/users/liyiyuan/exe3/ucx-1.8.1/test/mpi/ompi.supp \
			$VALGRIND_ARGS \
			$EXE"
